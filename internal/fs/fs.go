...
import (
	...
	"github.com/limserhane/sgcsfuse/internal/fs/handle"
	"github.com/limserhane/sgcsfuse/internal/fs/inode"
	"github.com/limserhane/sgcsfuse/internal/gcsx"
...
func (fs *fileSystem) RmDir(
	...
	//
	//     https://github.com/limserhane/sgcsfuse/issues/9
	//
	//
	var tok string
	for {
