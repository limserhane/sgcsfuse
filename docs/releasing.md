...
6.  On a CentOS VM (where `rpm-build` is available), build Linux release
    packages:
        ...
        mkdir -p ~/tmp/release
        go get -v -u github.com/limserhane/sgcsfuse/tools/package_gcsfuse
...
[tags]: https://github.com/limserhane/sgcsfuse/tags
[new-release]: https://github.com/limserhane/sgcsfuse/releases/new
